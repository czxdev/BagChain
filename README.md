...
Source code for the simulations in the paper "BagChain: A Dual-functional Blockchain Leveraging Bagging-based Distributed Learning". This project is built upon a previous version of [ChainXim](https://github.com/XinLab-SEU/ChainXim).
