...
if __name__ == '__main__':
    ...
    noniid_conf = {'type':'label_distribution', 'global_ratio':0.1,
                   'label_per_miner':3, 'beta':0.5, 'base_global_experiment': True}
    # 待测参数序列
    TASK_TYPE = 'C-FEMNIST-ResNet18' # C-SVHN-ResNet18
    GLOBAL_TRAINING_SET_RATIO = [1, 0.5, 0.3, 0.08, 0.02, 0.005] #
    BETA = [5, 0.5] # [0.25, 0.5, 1, 5] # [0.1, 0.25, 0.5, 1, 5, 15]
    MINER_NUM = 10
    BLOCKSIZE = 6
